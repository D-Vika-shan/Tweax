    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('tweax.optimizeSelection', async () => {
            ...
            try {
                ...
                const { optimized_code, explanation, time_complexity, cpu_usage, memory_usage, error } = response.data;
                ...
                panel.webview.postMessage({
                    type: 'update',
                    optimizedCode: extractCodeBlock(optimized_code), // Extract only the optimized code
                    explanation: explanation || "No explanation available.",
                    timeComplexity: time_complexity || "Not available.",
                    cpuUsage: cpu_usage || "Not available.",
                    memoryUsage: memory_usage || "Not available."
                });
            } catch (error) {
            ...
            <script>
                ...
                window.addEventListener('message', event => {
                    ...
                    if (message.type === 'update') {
                        ...
                        document.getElementById('cpuUsage').innerText = message.cpuUsage;
                        document.getElementById('memoryUsage').innerText = message.memoryUsage;
                    }
                });
